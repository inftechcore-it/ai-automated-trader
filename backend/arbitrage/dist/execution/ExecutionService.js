...
export class ExecutionService extends EventEmitter {
    ...
    async runCrossExchangeExecution(session, amount) {
    ...
    async executeStep1Validate(session, opp, amount) {
    ...
    async executeStep2Buy(session, opp, amount) {
    ...
    async executeStep3Transfer(session, opp, buyResult) {
    ...
    async executeStep4Sell(session, opp, transferResult) {
    ...
    async executeStep5Summary(session, buyResult, sellResult) {
        const opp = session.opportunity;
    ...
    async runTriangularExecution(session, amount) {
        const opp = session.opportunity;
        try {
    ...
    emitStepUpdate(session, step, status, data, error) {
...
export function createExecutionService(adapters, config) {
