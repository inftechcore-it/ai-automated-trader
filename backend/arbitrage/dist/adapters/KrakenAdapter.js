...
export class KrakenAdapter extends BaseAdapter {
    ...
    async initialize(config) {
        ...
        this.exchange = new ccxt.kraken(options);
        try {
    ...
    async placeOrder(params) {
        ...
        try {
            ...
            const order = await exchange.createOrder(params.symbol, params.type, params.side, params.quantity, params.price, ccxtParams);
            return {
                orderId: order.id,
