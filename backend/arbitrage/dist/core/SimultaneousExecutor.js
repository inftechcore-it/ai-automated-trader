...
export class SimultaneousExecutor extends EventEmitter {
    ...
    constructor(adapters, capitalManager, config = {}) {
        super();
     ...
     */
    async executeSimultaneous(opportunity, amountUSDT) {
        ...
        try {
            ...
            const capitalCheck = this.capitalManager.canExecuteArbitrage(opportunity.buyExchange, opportunity.sellExchange, opportunity.asset, amountUSDT);
    ...
    async placeOrderWithRetry(adapter, symbol, side, quantity, expectedPrice) {
        let lastError = null;
    ...
    simulateExecution(execution, opportunity, buyLeg, sellLeg) {
...
export function createSimultaneousExecutor(adapters, capitalManager, config) {
