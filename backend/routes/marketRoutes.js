...
import { history, quote, search, patterns, candlestickPatterns } from '../controllers/marketController.js';
...
router.get('/patterns', requireAuth, validateQuery('symbol').trim().notEmpty(), validate, patterns);
router.get('/candlestick-patterns', requireAuth, candlestickPatterns);
